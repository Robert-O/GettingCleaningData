...
#### Load the test set of measurements
test_set = read.table('./UCI HAR Dataset/test/X_test.txt')

#### Merge the test and training set of measurements
...
### merge measurements, labels, and subjects
...
### replace activity identifiers with the acitivity labels
count = 0
